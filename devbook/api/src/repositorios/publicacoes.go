...
//Buscar traz as publicaçoes dos usuarios seguidos e usuario que fez a requisição
...
//Atualizar altera os dados de uma publicação no bannco de dados
...
//BuscarPorUsuario busca todas as publicações de um determinado usuario no banco de dados
